...
hist(logusAir$temp, main="log temp", xlab="") 
hist(sqrtusAir$manu, main="sqrt manu", xlab="") 
hist(sqrtusAir$popul, main="sqrt popul", xlab="") 
hist(usAir$wind, main="raw wind", xlab="")
hist(usAir$precip, main="raw precip", xlab="")
hist(usAir$predays, main="raw predays", xlab="")
```
...
The axes indicate how strongly each characteristic (variable vector) influence the variation (principal components).  
