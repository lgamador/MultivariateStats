...
#### Determining number of axes to keep
**Scree plot**
You now have **_** PC axes. Which ones give us vital information and which ones can we toss?  
```{r}
...
text(phe_pca$loadings, labels=as.character(colnames(pheAir)), pos=1, cex=1)
```
